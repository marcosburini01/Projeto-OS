...
include("conphp.php");
$sql = mysqli_query($conn, "Select * From concluido;");
  ...
  <div id="botoes">
	...
	<form method="POST">
		<table class="table table-bordered">
            ...
            echo "<tr><td><p>" . $escrever['id'] . "</p></td><td><p>" . $escrever['nome'] . "</p></td><td><p>" . $escrever['secao'] . "</p></td><td><p>" . $escrever['assunto'] . "</p></td><td><p>" . $escrever['data_conc'] . "</p></td><td><p>" . $escrever['nota'] . "</p></td><td><p>" . $escrever['tec'] .  "</p></td></tr>";
